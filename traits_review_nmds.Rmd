...
```{r Data Manipulation, include=F, echo=F, eval=F}
...
```{r Data - remove zero sum,  include=F, eval=F, echo=F}
# Remove zero sum columns and rows from the dataframe
str(review_traits_fix)
...
```{r Data - randomly select among DOIs, include=F, eval=F, echo=F}
...
write.csv(review_traits4.0, "review_traits_use.csv")
...
review_traits_use <- read_csv("review_traits_use.csv")
...
traits_ord_use <- readRDS("traits_ord_use.rds")
